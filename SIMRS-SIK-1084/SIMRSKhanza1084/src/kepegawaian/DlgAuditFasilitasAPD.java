 ...
 * @author perpustakaan
 */
public final class DlgAuditFasilitasAPD extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAuditFasilitasAPD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tanggal Audit","ID Ruang","Ruang/Unit","1.Ada kebijakan pembuangan limbah rumah sakit",
            "2.Tersedia masker diruang perawatan, intensif, ruang tindakan sesuai dengan kebutuhan",
            "3.Tersedia sarung tangan on steril & steril diruangan, intensif, dan ruang tindakan sesuai kebutuhan",
            "4.Tersedia topi diruangan intensif, ruang tindakan sesuai dengan kebutuhan",
            "5.Tersedia gaun diruangan , intensif, ruang tindakan sesuai dengan kebutuhan",
            "6.Tersedia sepatu boot ( sepatu penutup )","Ttl.Nilai(%)"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Audit Fasilitas Alat Pelindung Diri (APD) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel14.setText("1.  Ada kebijakan pembuangan limbah rumah sakit");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(64, 40, 270, 23);
        ...
        jLabel17.setText("2.  Tersedia masker diruang perawatan, intensif, ruang tindakan sesuai dengan kebutuhan");
        ...
        jLabel23.setText("3.  Tersedia sarung tangan on steril & steril diruangan, intensif, dan ruang tindakan sesuai kebutuhan");
        ...
        jLabel22.setText("4.  Tersedia topi diruangan intensif, ruang tindakan sesuai dengan kebutuhan");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(64, 130, 450, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText("5.  Tersedia gaun diruangan , intensif, ruang tindakan sesuai dengan kebutuhan");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(64, 160, 410, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("6.  Tersedia sepatu boot ( sepatu penutup )");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(64, 190, 310, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(KdRuang.getText().trim().equals("")||NmRuang.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("audit_fasilitas_apd","?,?,?,?,?,?,?,?","Data",8,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            if(Sequel.queryu2tf("delete from audit_fasilitas_apd where id_ruang=? and tanggal=?",2,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(KdRuang.getText().trim().equals("")||NmRuang.getText().trim().equals("")){
            ...
            Sequel.mengedit("audit_fasilitas_apd","id_ruang=? and tanggal=?","tanggal=?,id_ruang=?,audit1=?,audit2=?,audit3=?,"+
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptAuditFasilitasAPD.jasper","report","::[ Data Audit Fasilitas APD ]::",
                    ...
                    "audit_fasilitas_apd.audit4,audit_fasilitas_apd.audit5,"+
                    "audit_fasilitas_apd.audit6 from audit_fasilitas_apd "+
                    "inner join ruang_audit_kepatuhan on audit_fasilitas_apd.id_ruang=ruang_audit_kepatuhan.id_ruang where audit_fasilitas_apd.tanggal between "+
                    "'"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' order by audit_fasilitas_apd.tanggal",param);
            }else{
                Valid.MyReportqry("rptAuditFasilitasAPD.jasper","report","::[ Data Audit Fasilitas APD ]::",
                    "select audit_fasilitas_apd.id_ruang,ruang_audit_kepatuhan.nama_ruang,audit_fasilitas_apd.tanggal,audit_fasilitas_apd.audit1,"+
                    "audit_fasilitas_apd.audit2,audit_fasilitas_apd.audit3,"+
                    ...
                    "and (audit_fasilitas_apd.id_ruang like '%"+TCari.getText().trim()+"%' or ruang_audit_kepatuhan.nama_ruang like '%"+TCari.getText().trim()+"%') order by audit_fasilitas_apd.tanggal",param);
            }  
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAuditFasilitasAPD dialog = new DlgAuditFasilitasAPD(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "audit_fasilitas_apd.audit4,audit_fasilitas_apd.audit5,"+
                    "audit_fasilitas_apd.audit6 from audit_fasilitas_apd "+
                    "inner join ruang_audit_kepatuhan on audit_fasilitas_apd.id_ruang=ruang_audit_kepatuhan.id_ruang "+
                    "where audit_fasilitas_apd.tanggal between ? and ? order by audit_fasilitas_apd.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select audit_fasilitas_apd.id_ruang,ruang_audit_kepatuhan.nama_ruang,audit_fasilitas_apd.tanggal,audit_fasilitas_apd.audit1,"+
                    "audit_fasilitas_apd.audit2,audit_fasilitas_apd.audit3,"+
                    ...
                    "audit_fasilitas_apd.audit6 from audit_fasilitas_apd "+
                    "inner join ruang_audit_kepatuhan on audit_fasilitas_apd.id_ruang=ruang_audit_kepatuhan.id_ruang "+
                    "where audit_fasilitas_apd.tanggal between ? and ? "+
                    "and (audit_fasilitas_apd.id_ruang like ? or ruang_audit_kepatuhan.nama_ruang like ?) order by audit_fasilitas_apd.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getaudit_fasilitas_apd());
        BtnHapus.setEnabled(akses.getaudit_fasilitas_apd());
        BtnEdit.setEnabled(akses.getaudit_fasilitas_apd());
        BtnPrint.setEnabled(akses.getaudit_fasilitas_apd());         
    }
