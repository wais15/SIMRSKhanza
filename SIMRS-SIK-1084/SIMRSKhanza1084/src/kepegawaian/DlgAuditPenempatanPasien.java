 ...
 * @author perpustakaan
 */
public final class DlgAuditPenempatanPasien extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAuditPenempatanPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tanggal Audit","ID Ruang","Ruang/Unit","1.Petugas Melakukan Kebersihan Tangan",
            ...
            "4.Petugas Menempatkan Pasien Dengan Sesuai Kecurigaan Penularan Udara Di Ruang Isolasi Dengan Ventilasi Negatif (-)",
            ...
            "8.Petugas Melepaskan Segera APD","9.Petugas Melakukan Kebersihan Tangan Setelah Kontak Pasien","Ttl.Nilai(%)"
        }){
    ...
    private void initComponents() {
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(192, 335));
        ...
        jLabel14.setText("1.  Petugas Melakukan Kebersihan Tangan");
        ...
        jLabel17.setText("2.  Petugas Menggunakan APD Sesuai Dengan Pola Transmisi Infeksi Pasien");
        ...
        jLabel23.setText("3.  Petugas Menempatkan Pasien Sesuai Dengan Pola Transmisi Infeksi Penyakit Pasien (Kontak, Udara, Droplet)");
        ...
        jLabel15.setText("8.  Petugas Melepaskan Segera APD");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(64, 250, 600, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("7.  Petugas Memberikan Edukasi Berdasarkan Jenis Transmisinya (Kontak, Droplet, Udara) Untuk Semua Ruangan");
        ...
        jLabel27.setText("9.  Petugas Melakukan Kebersihan Tangan Setelah Kontak Pasien");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(KdRuang.getText().trim().equals("")||NmRuang.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("audit_penempatan_pasien","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            if(Sequel.queryu2tf("delete from audit_penempatan_pasien where id_ruang=? and tanggal=?",2,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptAuditPenempatanPasien.jasper","report","::[ Data Audit Penempatan Pasien ]::",
                    ...
                    "audit_penempatan_pasien.audit2,audit_penempatan_pasien.audit3,"+
                    "audit_penempatan_pasien.audit4,audit_penempatan_pasien.audit5,"+
                    "audit_penempatan_pasien.audit6,audit_penempatan_pasien.audit7,"+
                    "audit_penempatan_pasien.audit8,audit_penempatan_pasien.audit9 from audit_penempatan_pasien "+
                    ...
                    "'"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' order by audit_penempatan_pasien.tanggal",param);
            }else{
                Valid.MyReportqry("rptAuditPenempatanPasien.jasper","report","::[ Data Audit Penempatan Pasien ]::",
                    "select audit_penempatan_pasien.id_ruang,ruang_audit_kepatuhan.nama_ruang,audit_penempatan_pasien.tanggal,audit_penempatan_pasien.audit1,"+
                    "audit_penempatan_pasien.audit2,audit_penempatan_pasien.audit3,"+
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "audit_penempatan_pasien.audit6,audit_penempatan_pasien.audit7,"+
                    "audit_penempatan_pasien.audit8,audit_penempatan_pasien.audit9 from audit_penempatan_pasien "+
                    "inner join ruang_audit_kepatuhan on audit_penempatan_pasien.id_ruang=ruang_audit_kepatuhan.id_ruang "+
                    "where audit_penempatan_pasien.tanggal between ? and ? order by audit_penempatan_pasien.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select audit_penempatan_pasien.id_ruang,ruang_audit_kepatuhan.nama_ruang,audit_penempatan_pasien.tanggal,audit_penempatan_pasien.audit1,"+
                    "audit_penempatan_pasien.audit2,audit_penempatan_pasien.audit3,"+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("audit3"),rs.getString("audit4"),rs.getString("audit5"),rs.getString("audit6"),rs.getString("audit7"),rs.getString("audit8"),
                        rs.getString("audit9"),Math.round(((audit1+audit2+audit3+audit4+audit5+audit6+audit7+audit8+audit9)/9)*100)+" %"
                    });
                    i++;
                }
                i=i-1;
