 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRalanKandungan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Jalan Kebidanan & Kandungan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        scrollPane9.setBounds(44, 720, 260, 63);
        ...
        jLabel80.setBounds(44, 700, 150, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Kardiotokografi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(319, 700, 150, 23);
        ...
        scrollPane10.setBounds(319, 720, 260, 63);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText("Laboratorium :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(594, 700, 150, 23);
        ...
        scrollPane11.setBounds(594, 720, 260, 63);
        ...
        scrollPane8.setBounds(510, 600, 344, 73);

        jLabel79.setText("RT :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(476, 600, 30, 23);

        jLabel27.setText("His :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(365, 490, 40, 23);
        ...
        FormInput.add(His);
        His.setBounds(409, 490, 60, 23);

        jLabel34.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel34.setText("x/10 Menit");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(472, 490, 60, 23);

        jLabel54.setText("TFU :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(0, 490, 98, 23);
        ...
        FormInput.add(TFU);
        TFU.setBounds(102, 490, 60, 23);

        jLabel55.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel55.setText("Cm");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(165, 490, 30, 23);

        jLabel56.setText("TBJ :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(200, 490, 50, 23);
        ...
        FormInput.add(TBJ);
        TBJ.setBounds(254, 490, 60, 23);

        jLabel57.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel57.setText("gram");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(317, 490, 30, 23);

        jLabel58.setText("Kontraksi :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(540, 490, 80, 23);
        ...
        Kontraksi.setBounds(624, 490, 80, 23);

        jLabel59.setText("DJJ :");
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(725, 490, 40, 23);
        ...
        FormInput.add(DJJ);
        DJJ.setBounds(769, 490, 60, 23);

        jLabel60.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel60.setText("Dpm");
        jLabel60.setName("jLabel60"); // NOI18N
        FormInput.add(jLabel60);
        jLabel60.setBounds(832, 490, 40, 23);
        ...
        scrollPane15.setBounds(102, 520, 344, 73);
        ...
        scrollPane16.setBounds(102, 600, 344, 73);
        ...
        scrollPane17.setBounds(510, 520, 344, 73);

        jLabel84.setText("Inspeksi :");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(0, 520, 98, 23);

        jLabel85.setText("Inspekulo :");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(0, 600, 98, 23);

        jLabel86.setText("VT :");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(476, 520, 30, 23);
            ...
            try{
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'><b>TFU</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'><b>TBJ</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'><b>His</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'><b>Kontraksi</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'><b>DJJ</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='300px'><b>Inspeksi</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='300px'><b>Inspekulo</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='200px'><b>VT</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='200px'><b>RT</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='170px'><b>Ultrasonografi</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='170px'><b>Kardiotokografi</b></td>"+
                            ...
                            "<table width='5500px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA PENGKAJIAN AWAL MEDIS RAWAT JALAN KANDUNGAN<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanKebidanan.jasper","report","::[ Laporan Pengkajian Awal Medis Rawat Jalan Kebidanan & Kandungan ]::",
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanKandungan dialog = new RMPenilaianAwalMedisRalanKandungan(new javax.swing.JFrame(), true);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_kandungan where no_rawat=?",1,new String[]{
