...
<div style="width: 100%; height: 99%; overflow: auto;">
    <?php
        $_sql   = "SELECT pegawai.id,pegawai.nik,pegawai.nama,pegawai.departemen,pegawai.bidang FROM pegawai where pegawai.stts_aktif='AKTIF' and (pegawai.nik like '%".$keyword."%' or pegawai.nama like '%".$keyword."%') order by pegawai.id ASC ";
        ...
        if(mysqli_num_rows($hasil)!=0) {
            echo "<table width='99.8%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    ...
                    while($baris = mysqli_fetch_array($hasil)) {
                        ...
                        $_sql2    = "SELECT riwayat_seminar.nama_seminar,riwayat_seminar.mulai,riwayat_seminar.penyelengara,riwayat_seminar.tempat from riwayat_seminar where riwayat_seminar.id='$baris[0]' ORDER BY riwayat_seminar.mulai ASC ";
