                    ...
                    echo "<table width='99.6%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                            ...
                            while($baris = mysqli_fetch_array($hasil)) {
                                echo "<tr class='isi' title='$baris[1] $baris[2]'>
                                        ...
                                        <td>$baris[3]</td>
                                        <td>";
                                $_sql2  = "select master_tunjangan_bulanan.nama,master_tunjangan_bulanan.tnj from pnm_tnj_bulanan inner join master_tunjangan_bulanan on pnm_tnj_bulanan.id_tnj=master_tunjangan_bulanan.id where pnm_tnj_bulanan.id='$baris[0]'";
                                ...
                                echo "    <a href=?act=DetailPenerimaTunjanganBulanan&action=TAMBAH&id=$baris[0]>[Update]</a>
                                        ...
                                        <td>";
                                $_sql2  = "select master_tunjangan_harian.nama,master_tunjangan_harian.tnj from pnm_tnj_harian inner join master_tunjangan_harian on pnm_tnj_harian.id_tnj=master_tunjangan_harian.id where pnm_tnj_harian.id='$baris[0]'";
                                $hasil2=bukaquery($_sql2);
                                while($baris2 = mysqli_fetch_array($hasil2)) {
                                    echo "<table width='100%'><tr class='isi3'><td width='65%'>$baris2[0]</td><td width='35%'>: ".formatDuit($baris2[1])."</td></tr></table>";
                                }
