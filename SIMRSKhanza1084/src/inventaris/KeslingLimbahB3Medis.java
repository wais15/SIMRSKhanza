...
public final class KeslingLimbahB3Medis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Tujuan Penyerahan Limbah B3 :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(251, 40, 160, 23);
        ...
        KdPetugas.setBounds(84, 10, 117, 23);
    ...
    private void TujuanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TujuanKeyPressed
        Valid.pindah(evt,NoDokumen,Jumlah);
}//GEN-LAST:event_TujuanKeyPressed

    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Jumlah.getText().trim().equals("")){
            Valid.textKosong(Jumlah,"Jumlah limbah keluar");
        }else if(Tujuan.getText().trim().equals("")){
            Valid.textKosong(Tujuan,"Tujuan Penyerahan");
        }else if(Sisa.getText().trim().equals("")){
            Valid.textKosong(Sisa,"Sisa di TPS");
        }else if(NoDokumen.getText().trim().equals("")){
            Valid.textKosong(NoDokumen,"Bukti No.Dokumen penyerahan");
    ...
    private void TanggalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalKeyPressed
        Valid.pindah(evt,btnPetugas,NoDokumen);
