 ...
 * @author perpustakaan
 */
public final class DlgAuditBundleIDO extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAuditBundleIDO(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tanggal Audit","ID Ruang","Ruang/Unit","1.Pencukuran Rambut Yang Mengganggu Jalannya Operasi",
            "2.Antibiotik","3.Temperatur (Suhu Pasien)","4.Sugar (Gula Darah Pasien)","Ttl.Nilai(%)"
        }){
    ...
    private void initComponents() {
        ...
        PencukuranRambut = new widget.ComboBox();
        jLabel17 = new widget.Label();
        Antibiotik = new widget.ComboBox();
        jLabel23 = new widget.Label();
        SuhuPasien = new widget.ComboBox();
        NmRuang = new widget.TextBox();
        GulaDarah = new widget.ComboBox();
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-06-2022" }));
        ...
        jLabel14.setText("1.  Pencukuran Rambut Yang Mengganggu Jalannya Operasi");
        ...
        PencukuranRambut.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PencukuranRambutKeyPressed(evt);
            }
        });
        FormInput.add(PencukuranRambut);
        PencukuranRambut.setBounds(330, 40, 78, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("2.  Antibiotik");
        ...
        Antibiotik.setBounds(800, 40, 78, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("3.  Temperatur (Suhu Pasien)");
        ...
        SuhuPasien.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                SuhuPasienKeyPressed(evt);
            }
        });
        FormInput.add(SuhuPasien);
        SuhuPasien.setBounds(330, 70, 78, 23);
        ...
        GulaDarah.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                GulaDarahKeyPressed(evt);
            }
        });
        FormInput.add(GulaDarah);
        GulaDarah.setBounds(800, 70, 78, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("4.  Sugar (Gula Darah Pasien)");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(564, 70, 210, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(KdRuang.getText().trim().equals("")||NmRuang.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("audit_bundle_ido","?,?,?,?,?,?","Data",6,new String[]{
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,GulaDarah,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            if(Sequel.queryu2tf("delete from audit_bundle_ido where id_ruang=? and tanggal=?",2,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptAuditBundleIDO.jasper","report","::[ Data Audit Bundle IDO ]::",
                    ...
                    "'"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' order by audit_bundle_ido.tanggal",param);
            }else{
                Valid.MyReportqry("rptAuditBundleIDO.jasper","report","::[ Data Audit Bundle IDO ]::",
                    "select audit_bundle_ido.id_ruang,ruang_audit_kepatuhan.nama_ruang,audit_bundle_ido.tanggal,audit_bundle_ido.pencukuran_rambut,"+
                    "audit_bundle_ido.antibiotik,audit_bundle_ido.temperature,"+
    ...
    private void PencukuranRambutKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PencukuranRambutKeyPressed
        Valid.pindah(evt,btnPetugas,Antibiotik);
    }//GEN-LAST:event_PencukuranRambutKeyPressed

    private void AntibiotikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AntibiotikKeyPressed
        Valid.pindah(evt, PencukuranRambut, SuhuPasien);
    }//GEN-LAST:event_AntibiotikKeyPressed

    private void SuhuPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SuhuPasienKeyPressed
        Valid.pindah(evt, Antibiotik,GulaDarah);
    }//GEN-LAST:event_SuhuPasienKeyPressed

    private void GulaDarahKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_GulaDarahKeyPressed
        Valid.pindah(evt, SuhuPasien,BtnSimpan);
    }//GEN-LAST:event_GulaDarahKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAuditBundleIDO dialog = new DlgAuditBundleIDO(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox GulaDarah;
    ...
    private widget.ComboBox PencukuranRambut;
    private widget.ScrollPane Scroll;
    private widget.ComboBox SuhuPasien;
    ...
    public void emptTeks() {
        ...
        PencukuranRambut.setSelectedIndex(0);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            if(!tbObat.getValueAt(tbObat.getSelectedRow(),0).toString().equals("")){
                ...
                PencukuranRambut.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),3).toString());
                Antibiotik.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString());
                SuhuPasien.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
                GulaDarah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
