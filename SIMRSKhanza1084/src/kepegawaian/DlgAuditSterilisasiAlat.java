 ...
 * @author perpustakaan
 */
public final class DlgAuditSterilisasiAlat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAuditSterilisasiAlat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tanggal Audit","ID Ruang","Ruang/Unit","1.Petugas pakai alat pelindung diri ( masker, sarung tangan, gaun) lengkap",
            ...
            "11.Alat yang sudah steril disimpan dalam lemari tertutup dengan jarak dari lantai ± 60cm tidak tercampur dengan barang lain","Ttl.Nilai(%)"
        }){
    ...
    private void initComponents() {
        ...
        Audit9 = new widget.ComboBox();
        Audit10 = new widget.ComboBox();
        jLabel28 = new widget.Label();
        Audit11 = new widget.ComboBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Audit Sterilisasi Alat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 372));
        FormInput.setLayout(null);

        Tanggal.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-07-2022" }));
        ...
        jLabel14.setText("1.  Petugas pakai alat pelindung diri ( masker, sarung tangan, gaun) lengkap");
        ...
        jLabel17.setText("2.  Perendaman alat sampai seluruh permukaan alat");
        ...
        jLabel23.setText("3.  Perendaman menggunakan cairan enzymatic selama 10-15 menit");
        ...
        jLabel15.setText("8.  Petugas melakukan kebersihan tangan");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(64, 250, 600, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("7.  Petugas melepaskan APD yang sudah dipakai");
        ...
        jLabel22.setText("4.  Petugas membersihkan alat dengan sikat lembut dan sampai ke sela - sela alat ");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(64, 130, 600, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText("5.  Peralatan dibersihkan dengan air mengalir setelah direndam dengan enzmatic");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(64, 160, 600, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("6.  Petugas mengeringkan alat yang telah dibersihkan");
        ...
        jLabel27.setText("9.  Petugas melakukan pengepakan alat dan pelebelan alat");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(64, 280, 600, 23);

        Audit9.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        Audit9.setName("Audit9"); // NOI18N
        Audit9.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Audit9KeyPressed(evt);
            }
        });
        FormInput.add(Audit9);
        Audit9.setBounds(710, 280, 78, 23);

        Audit10.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        Audit10.setName("Audit10"); // NOI18N
        Audit10.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Audit10KeyPressed(evt);
            }
        });
        FormInput.add(Audit10);
        Audit10.setBounds(710, 310, 78, 23);

        jLabel28.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel28.setText("10.  Petugas membawa alat yang sudah siap untuk disterilkan ke ruang steril");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(64, 310, 600, 23);

        Audit11.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        Audit11.setName("Audit11"); // NOI18N
        Audit11.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Audit11KeyPressed(evt);
            }
        });
        FormInput.add(Audit11);
        Audit11.setBounds(710, 340, 78, 23);

        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel29.setText("11.  Alat yang sudah steril disimpan dalam lemari tertutup dengan jarak dari lantai ± 60cm tidak tercampur dengan barang lain");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(64, 340, 640, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(KdRuang.getText().trim().equals("")||NmRuang.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("audit_sterilisasi_alat","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{
                ...
                Audit8.getSelectedItem().toString(),Audit9.getSelectedItem().toString(),Audit10.getSelectedItem().toString(),
                Audit11.getSelectedItem().toString()
            })==true){
                tampil();
                emptTeks();
            }  
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            if(Sequel.queryu2tf("delete from audit_sterilisasi_alat where id_ruang=? and tanggal=?",2,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(KdRuang.getText().trim().equals("")||NmRuang.getText().trim().equals("")){
            ...
            Sequel.mengedit("audit_sterilisasi_alat","id_ruang=? and tanggal=?","tanggal=?,id_ruang=?,audit1=?,audit2=?,audit3=?,"+
                "audit4=?,audit5=?,audit6=?,audit7=?,audit8=?,audit9=?,audit10=?,audit11=?",15,new String[]{
                Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),KdRuang.getText(),Audit1.getSelectedItem().toString(),
                Audit2.getSelectedItem().toString(),Audit3.getSelectedItem().toString(),Audit4.getSelectedItem().toString(),
                Audit5.getSelectedItem().toString(),Audit6.getSelectedItem().toString(),Audit7.getSelectedItem().toString(),
                Audit8.getSelectedItem().toString(),Audit9.getSelectedItem().toString(),Audit10.getSelectedItem().toString(),
                Audit11.getSelectedItem().toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            });
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptAuditSterilisasiAlat.jasper","report","::[ Data Audit Sterilisasi Alat ]::",
                    ...
                    "audit_sterilisasi_alat.audit4,audit_sterilisasi_alat.audit5,"+
                    "audit_sterilisasi_alat.audit6,audit_sterilisasi_alat.audit7,"+
                    "audit_sterilisasi_alat.audit8,audit_sterilisasi_alat.audit9,"+
                    "audit_sterilisasi_alat.audit10,audit_sterilisasi_alat.audit11 from audit_sterilisasi_alat "+
                    "inner join ruang_audit_kepatuhan on audit_sterilisasi_alat.id_ruang=ruang_audit_kepatuhan.id_ruang where audit_sterilisasi_alat.tanggal between "+
                    "'"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' order by audit_sterilisasi_alat.tanggal",param);
            }else{
                Valid.MyReportqry("rptAuditSterilisasiAlat.jasper","report","::[ Data Audit Sterilisasi Alat ]::",
                    "select audit_sterilisasi_alat.id_ruang,ruang_audit_kepatuhan.nama_ruang,audit_sterilisasi_alat.tanggal,audit_sterilisasi_alat.audit1,"+
                    "audit_sterilisasi_alat.audit2,audit_sterilisasi_alat.audit3,"+
                    ...
                    "and (audit_sterilisasi_alat.id_ruang like '%"+TCari.getText().trim()+"%' or ruang_audit_kepatuhan.nama_ruang like '%"+TCari.getText().trim()+"%') order by audit_sterilisasi_alat.tanggal",param);
            }  
        }
    ...
    private void Audit9KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Audit9KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Audit9KeyPressed

    private void Audit10KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Audit10KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Audit10KeyPressed

    private void Audit11KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Audit11KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Audit11KeyPressed
    ...
    */
    ...
    private widget.ComboBox Audit10;
    private widget.ComboBox Audit11;
    ...
    private widget.ComboBox Audit9;
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "audit_sterilisasi_alat.audit10,audit_sterilisasi_alat.audit11 from audit_sterilisasi_alat "+
                    "inner join ruang_audit_kepatuhan on audit_sterilisasi_alat.id_ruang=ruang_audit_kepatuhan.id_ruang "+
                    "where audit_sterilisasi_alat.tanggal between ? and ? "+
                    "and (audit_sterilisasi_alat.id_ruang like ? or ruang_audit_kepatuhan.nama_ruang like ?) order by audit_sterilisasi_alat.tanggal");
            }
            ...
            try {
                ...
                ttlaudit6=0;ttlaudit7=0;ttlaudit8=0;ttlaudit9=0;ttlaudit10=0;ttlaudit11=0;ttlpenilaian=0;
                i=1;
                while(rs.next()){
                ...
                if(i>0){
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        Math.round((ttlaudit10/i)*100)+" %",Math.round((ttlaudit11/i)*100)+" %",Math.round(ttlpenilaian/i)+" %"
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Audit10.setSelectedIndex(0);
        Audit11.setSelectedIndex(0);
        Audit1.requestFocus();
    } 
    ...
    public void isCek(){
        ...
        BtnEdit.setEnabled(akses.getaudit_sterilisasi_alat());
        BtnPrint.setEnabled(akses.getaudit_sterilisasi_alat());         
    }
