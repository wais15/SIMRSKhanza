 ...
 * @author dosen
 */
public class MasterMasalahKeperawatanGeriatri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterMasalahKeperawatanGeriatri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Masalah Keperawatan"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("master_masalah_keperawatan_geriatri","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TKd,"master_masalah_keperawatan_geriatri","kode_masalah")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_masalah_keperawatan_geriatri","kode_masalah=?","kode_masalah=?,nama_masalah=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatanGeriatri dialog = new MasterMasalahKeperawatanGeriatri(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_masalah_keperawatan_geriatri where master_masalah_keperawatan_geriatri.kode_masalah like ? or master_masalah_keperawatan_geriatri.nama_masalah like ? order by master_masalah_keperawatan_geriatri.kode_masalah");
            try {
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getmaster_masalah_keperawatan_geriatri());
    }
}
