 ...
 * @author perpustakaan
 */
public final class RMDataCatatanKeperawatanRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataCatatanKeperawatanRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Catatan Keperawatan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanKeperawatanRanap dialog = new RMDataCatatanKeperawatanRanap(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getcatatan_keperawatan_ranap());
        BtnHapus.setEnabled(akses.getcatatan_keperawatan_ranap());
        BtnEdit.setEnabled(akses.getcatatan_keperawatan_ranap());
        BtnPrint.setEnabled(akses.getcatatan_keperawatan_ranap()); 
        if(akses.getjml2()>=1){
            NIP.setEditable(false);
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_keperawatan_ranap","tanggal=? and jam=? and no_rawat=?","no_rawat=?,tanggal=?,jam=?,uraian=?,nip=?",8,new String[]{
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from catatan_keperawatan_ranap where tanggal=? and jam=? and no_rawat=?",3,new String[]{
    ...
    private void simpan() {
        if(Sequel.menyimpantf("catatan_keperawatan_ranap","?,?,?,?,?","Data",5,new String[]{
