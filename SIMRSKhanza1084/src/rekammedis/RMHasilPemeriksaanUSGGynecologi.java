...
public final class RMHasilPemeriksaanUSGGynecologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMHasilPemeriksaanUSGGynecologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hasil Pemeriksaan USG Gynecologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-02-2024 07:19:04" }));
        ...
        KirimanDari.setBounds(89, 80, 265, 23);
        ...
        jLabel44.setText("Doppler :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 320, 85, 23);

        scrollPane17.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane17.setName("scrollPane17"); // NOI18N

        Doppler.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Doppler.setColumns(20);
        Doppler.setRows(5);
        Doppler.setName("Doppler"); // NOI18N
        Doppler.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DopplerKeyPressed(evt);
            }
        });
        scrollPane17.setViewportView(Doppler);

        FormInput.add(scrollPane17);
        scrollPane17.setBounds(89, 320, 635, 63);

        jLabel45.setText("Uterus :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 110, 85, 23);
        ...
        Uterus.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Uterus.setColumns(20);
        Uterus.setRows(5);
        Uterus.setName("Uterus"); // NOI18N
        Uterus.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                UterusKeyPressed(evt);
            }
        });
        scrollPane18.setViewportView(Uterus);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(89, 110, 635, 63);

        jLabel46.setText("Parametrium :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 180, 85, 23);
        ...
        Parametrium.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Parametrium.setColumns(20);
        Parametrium.setRows(5);
        Parametrium.setName("Parametrium"); // NOI18N
        Parametrium.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ParametriumKeyPressed(evt);
            }
        });
        scrollPane19.setViewportView(Parametrium);

        FormInput.add(scrollPane19);
        scrollPane19.setBounds(89, 180, 635, 63);

        jLabel47.setText("Ovarium :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(0, 250, 85, 23);
        ...
        Ovarium.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Ovarium.setColumns(20);
        Ovarium.setRows(5);
        Ovarium.setName("Ovarium"); // NOI18N
        Ovarium.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                OvariumKeyPressed(evt);
            }
        });
        scrollPane20.setViewportView(Ovarium);

        FormInput.add(scrollPane20);
        scrollPane20.setBounds(89, 250, 635, 63);

        jLabel48.setText("Kesimpulan :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(0, 390, 85, 23);
    ...
    private void DiagnosaKlinisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaKlinisKeyPressed
        Valid.pindah(evt,KirimanDari,Uterus);
    }//GEN-LAST:event_DiagnosaKlinisKeyPressed

    private void DopplerKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DopplerKeyPressed
        Valid.pindah2(evt,Ovarium,Kesimpulan);
    }//GEN-LAST:event_DopplerKeyPressed
    ...
    private void UterusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_UterusKeyPressed
        Valid.pindah2(evt,DiagnosaKlinis,Parametrium);
    }//GEN-LAST:event_UterusKeyPressed

    private void ParametriumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ParametriumKeyPressed
        Valid.pindah2(evt,Uterus,Ovarium);
    }//GEN-LAST:event_ParametriumKeyPressed

    private void OvariumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_OvariumKeyPressed
        Valid.pindah2(evt,Parametrium,Doppler);
    }//GEN-LAST:event_OvariumKeyPressed

    private void KesimpulanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KesimpulanKeyPressed
        Valid.pindah2(evt,Doppler,BtnSimpan);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanUSGGynecologi dialog = new RMHasilPemeriksaanUSGGynecologi(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea Doppler;
    ...
    private widget.TextArea Ovarium;
    private widget.PanelBiasa PanelAccor;
    private widget.TextArea Parametrium;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Uterus.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("hasil_pemeriksaan_usg_gynecologi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,uterus=?,parametrium=?,ovarium=?,doppler=?,kesimpulan=?",11,new String[]{
                ...
                tbObat.setValueAt(Uterus.getText(),tbObat.getSelectedRow(),9);
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            try {
                ps=koneksi.prepareStatement("select hasil_pemeriksaan_usg_gynecologi_gambar.photo from hasil_pemeriksaan_usg_gynecologi_gambar where hasil_pemeriksaan_usg_gynecologi_gambar.no_rawat=?");
                try {
