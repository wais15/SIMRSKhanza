 ...
 * @author perpustakaan
 */
public final class RMHasilPemeriksaanUSGUrologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMHasilPemeriksaanUSGUrologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-02-2024 07:20:06" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanUSGUrologi dialog = new RMHasilPemeriksaanUSGUrologi(new javax.swing.JFrame(), true);
