 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRalanBedah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRalanBedah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Riwayat Penggunakan Obat","Riwayat Alergi","Kesadaran","Status Nutrisi","TD(mmHg)","Nadi(x/menit)","Suhu","RR(x/menit)","BB(Kg)","Nyeri","GCS","Kepala","Thoraks","Abdomen",
            "Ekstremitas","Genetalia Os Pubis","Columna Vertebralis","Muskuloskeletal","Lainnya","Status Lokalis","Laboratorium","Radiologi","Pemeriksaan","Diagnosis","Diagnosis Banding",
        ...
        Status.setDocument(new batasInput((int)50).getKata(Status));
        TD.setDocument(new batasInput((byte)8).getKata(TD));
        Nadi.setDocument(new batasInput((byte)5).getKata(Nadi));
        Suhu.setDocument(new batasInput((byte)5).getKata(Suhu));
        RR.setDocument(new batasInput((byte)5).getKata(RR));
        BB.setDocument(new batasInput((byte)5).getKata(BB));
        Nyeri.setDocument(new batasInput((int)50).getKata(Nyeri));
        GCS.setDocument(new batasInput((byte)10).getKata(GCS));
        Lainnya.setDocument(new batasInput((int)1000).getKata(Lainnya));
        KetLokalis.setDocument(new batasInput((int)1000).getKata(KetLokalis));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Jalan Bedah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1283));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2023 05:11:19" }));
        ...
        Status.setBounds(121, 270, 180, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(360, 270, 50, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(413, 270, 30, 23);
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(500, 270, 200, 23);

        jLabel44.setText("Muskuloskeletal :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(253, 330, 120, 23);
        ...
        Muskulos.setBounds(377, 330, 128, 23);

        jLabel50.setText("Columna Vertebralis :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(253, 300, 120, 23);
        ...
        Columna.setBounds(377, 300, 128, 23);

        jLabel40.setText("Kepala :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 300, 117, 23);
        ...
        Kepala.setBounds(121, 300, 128, 23);

        jLabel46.setText("Thoraks :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 330, 117, 23);
        ...
        Thoraks.setBounds(121, 330, 128, 23);

        jLabel49.setText("Abdomen :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(0, 360, 117, 23);
        ...
        Abdomen.setBounds(121, 360, 128, 23);

        jLabel51.setText("Ekstremitas :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(0, 390, 117, 23);
        ...
        Ekstremitas.setBounds(121, 390, 128, 23);
        ...
        scrollPane5.setBounds(524, 300, 330, 113);

        jLabel48.setText("Genetalia Os Pubis :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(253, 360, 120, 23);

        Genetalia.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        ...
        Genetalia.setBounds(377, 360, 128, 23);

        jLabel101.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel101.setText("IV. PEMERIKSAAN PENUNJANG");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(10, 830, 190, 23);
        ...
        scrollPane12.setBounds(594, 870, 260, 63);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("Penunjang Lainnya :");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(594, 850, 190, 23);
        ...
        scrollPane9.setBounds(44, 870, 260, 63);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText("Laboratorium :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(44, 850, 150, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Radiologi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(319, 850, 150, 23);
        ...
        scrollPane10.setBounds(319, 870, 260, 63);
        ...
        jSeparator17.setBounds(0, 940, 880, 1);

        jLabel106.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel106.setText("V. DIAGNOSIS/ASESMEN");
        jLabel106.setName("jLabel106"); // NOI18N
        FormInput.add(jLabel106);
        jLabel106.setBounds(10, 940, 190, 23);
        ...
        scrollPane15.setBounds(44, 980, 400, 43);
        ...
        jSeparator18.setBounds(0, 420, 880, 1);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("III. STATUS LOKALIS");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(10, 420, 180, 23);

        PanelWall.setBackground(new java.awt.Color(29, 29, 29));
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/LokalisOrtho.png"))); // NOI18N
        ...
        jLabel79.setBounds(44, 720, 100, 23);
        ...
        scrollPane8.setBounds(44, 740, 810, 83);
        ...
        jSeparator19.setBounds(0, 830, 880, 1);
        ...
        jSeparator20.setBounds(0, 1030, 880, 1);

        jLabel107.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel107.setText("VI. PERMASALAHAN & TATALAKSANA");
        jLabel107.setName("jLabel107"); // NOI18N
        FormInput.add(jLabel107);
        jLabel107.setBounds(10, 1030, 190, 23);
        ...
        scrollPane17.setBounds(454, 1070, 400, 43);
        ...
        scrollPane20.setBounds(44, 1070, 400, 43);
        ...
        scrollPane19.setBounds(44, 1140, 810, 43);
        ...
        jSeparator21.setBounds(0, 1190, 880, 1);

        jLabel109.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel109.setText("VII. EDUKASI");
        jLabel109.setName("jLabel109"); // NOI18N
        FormInput.add(jLabel109);
        jLabel109.setBounds(10, 1190, 190, 23);
            ...
            try{
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Genetalia Os Pubis</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Columna Vertebralis</b></td>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Status Lokalis</b></td>"+
                ...
                LoadHTML.setText(
                    "<html>"+
                      "<table width='4700px' border='0' align='center' cellpadding='1px' cellspacing='0' class='tbl_form'>"+
                ...
                bw.write(LoadHTML.getText().replaceAll("<head>","<head>"+
                            ...
                            "<table width='4700px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanBedah.jasper","report","::[ Laporan Pengkajian Awal Medis Rawat Jalan Bedah ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_bedah.tanggal,"+
                "penilaian_medis_ralan_bedah.kd_dokter,penilaian_medis_ralan_bedah.anamnesis,penilaian_medis_ralan_bedah.hubungan,penilaian_medis_ralan_bedah.keluhan_utama,"+
                ...
                "where penilaian_medis_ralan_bedah.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void MuskulosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MuskulosKeyPressed
        Valid.pindah(evt,Columna,Genetalia);
    ...
    private void ColumnaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ColumnaKeyPressed
        Valid.pindah(evt,Ekstremitas,Muskulos);
    ...
    private void LainnyaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LainnyaKeyPressed
        Valid.pindah2(evt,Genetalia,KetLokalis);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanBedah dialog = new RMPenilaianAwalMedisRalanBedah(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ralan_bedah on reg_periksa.no_rawat=penilaian_medis_ralan_bedah.no_rawat "+
                        "inner join dokter on penilaian_medis_ralan_bedah.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ralan_bedah.tanggal between ? and ? order by penilaian_medis_ralan_bedah.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_bedah.tanggal,"+
                        "penilaian_medis_ralan_bedah.kd_dokter,penilaian_medis_ralan_bedah.anamnesis,penilaian_medis_ralan_bedah.hubungan,penilaian_medis_ralan_bedah.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ralan_bedah on reg_periksa.no_rawat=penilaian_medis_ralan_bedah.no_rawat "+
                        "inner join dokter on penilaian_medis_ralan_bedah.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ralan_bedah.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ralan_bedah.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ralan_bedah.tanggal");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("td"),rs.getString("nadi"),rs.getString("suhu"),rs.getString("rr"),rs.getString("bb"),rs.getString("nyeri"),rs.getString("gcs"),rs.getString("kepala"),rs.getString("thoraks"),rs.getString("abdomen"),
                        rs.getString("ekstremitas"),rs.getString("genetalia"),rs.getString("columna"),rs.getString("muskulos"),rs.getString("lainnya"),rs.getString("ket_lokalis"),rs.getString("lab"),rs.getString("rad"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Kepala.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            Thoraks.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
            ...
            Columna.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            Muskulos.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            Genetalia.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            Lainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            KetLokalis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            Lab.setText(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString());
            Rad.setText(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());
            PenunjangLain.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            Diagnosis2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString());
            Permasalahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_bedah","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,"+
                "gcs=?,kepala=?,thoraks=?,abdomen=?,ekstremitas=?,genetalia=?,columna=?,muskulos=?,lainnya=?,ket_lokalis=?,lab=?,rad=?,pemeriksaan=?,diagnosis=?,diagnosis2=?,permasalahan=?,terapi=?,tindakan=?,edukasi=?",38,new String[]{
                ...
                Kepala.getSelectedItem().toString(),Thoraks.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),Genetalia.getSelectedItem().toString(),Columna.getSelectedItem().toString(),
                Muskulos.getSelectedItem().toString(),Lainnya.getText(),KetLokalis.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),Permasalahan.getText(),Terapi.getText(),Tindakan.getText(),
               ...
               tbObat.setValueAt(Status.getText(),tbObat.getSelectedRow(),16);
               ...
               tbObat.setValueAt(Nyeri.getText(),tbObat.getSelectedRow(),22);
               tbObat.setValueAt(GCS.getText(),tbObat.getSelectedRow(),23);
               tbObat.setValueAt(Kepala.getSelectedItem().toString(),tbObat.getSelectedRow(),24);
               tbObat.setValueAt(Thoraks.getSelectedItem().toString(),tbObat.getSelectedRow(),25);
               tbObat.setValueAt(Abdomen.getSelectedItem().toString(),tbObat.getSelectedRow(),26);
               tbObat.setValueAt(Ekstremitas.getSelectedItem().toString(),tbObat.getSelectedRow(),27);
               tbObat.setValueAt(Genetalia.getSelectedItem().toString(),tbObat.getSelectedRow(),28);
               tbObat.setValueAt(Columna.getSelectedItem().toString(),tbObat.getSelectedRow(),29);
               tbObat.setValueAt(Muskulos.getSelectedItem().toString(),tbObat.getSelectedRow(),30);
               tbObat.setValueAt(Lainnya.getText(),tbObat.getSelectedRow(),31);
               tbObat.setValueAt(KetLokalis.getText(),tbObat.getSelectedRow(),32);
               tbObat.setValueAt(Lab.getText(),tbObat.getSelectedRow(),33);
               tbObat.setValueAt(Rad.getText(),tbObat.getSelectedRow(),34);
               tbObat.setValueAt(PenunjangLain.getText(),tbObat.getSelectedRow(),35);
               tbObat.setValueAt(Diagnosis.getText(),tbObat.getSelectedRow(),36);
               tbObat.setValueAt(Diagnosis2.getText(),tbObat.getSelectedRow(),37);
               tbObat.setValueAt(Permasalahan.getText(),tbObat.getSelectedRow(),38);
               tbObat.setValueAt(Terapi.getText(),tbObat.getSelectedRow(),39);
               tbObat.setValueAt(Tindakan.getText(),tbObat.getSelectedRow(),40);
               tbObat.setValueAt(Edukasi.getText(),tbObat.getSelectedRow(),41);
               emptTeks();
               TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ralan_bedah","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Kesadaran.getSelectedItem().toString(),Status.getText(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),BB.getText(),Nyeri.getText(),GCS.getText(),
                Kepala.getSelectedItem().toString(),Thoraks.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),Genetalia.getSelectedItem().toString(),Columna.getSelectedItem().toString(),
                Muskulos.getSelectedItem().toString(),Lainnya.getText(),KetLokalis.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),Permasalahan.getText(),Terapi.getText(),Tindakan.getText(),
                ...
                tabMode.addRow(new Object[]{
                    ...
                    Anamnesis.getSelectedItem().toString(),Hubungan.getText(),KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Kesadaran.getSelectedItem().toString(),Status.getText(),TD.getText(),Nadi.getText(),
                    Suhu.getText(),RR.getText(),BB.getText(),Nyeri.getText(),GCS.getText(),Kepala.getSelectedItem().toString(),Thoraks.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),
                    Genetalia.getSelectedItem().toString(),Columna.getSelectedItem().toString(),Muskulos.getSelectedItem().toString(),Lainnya.getText(),KetLokalis.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),
                    Diagnosis2.getText(),Permasalahan.getText(),Terapi.getText(),Tindakan.getText(),Edukasi.getText()
                });
                LCount.setText(""+tabMode.getRowCount());
                emptTeks();
        }
