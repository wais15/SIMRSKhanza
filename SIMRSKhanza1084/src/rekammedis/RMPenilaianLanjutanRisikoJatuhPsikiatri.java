 ...
 * @author perpustakaan
 */
public final class RMPenilaianLanjutanRisikoJatuhPsikiatri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianLanjutanRisikoJatuhPsikiatri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Skala Edmonson 6","N.E. 6","Total","Hasil Skrining","Saran","NIP","Petugas"
        }){
    ...
    private void initComponents() {
        ...
        MnPenilaianLanjutanRisikoJatuh.setText("Formulir Pengkajian Lanjutan Risiko Jatuh Psikiatri");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Lanjutan Risiko Jatuh Pasien Psikiatri ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel219.setBounds(176, 90, 60, 23);

        SkalaResiko1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Kurang Dari 50 Th", "50 - 70 Th", "Lebih Dari 70 Th" }));
        ...
        SkalaResiko1.setBounds(240, 90, 430, 23);
        ...
        jLabel220.setBounds(34, 120, 150, 23);

        jLabel221.setText("Skala :");
        jLabel221.setName("jLabel221"); // NOI18N
        FormInput.add(jLabel221);
        jLabel221.setBounds(176, 120, 60, 23);

        SkalaResiko2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Kesadaran/Orientasi Baik Setiap Saat", "Agitasi/Ansietas", "Kadang-kadang Bingung", "Bingung/Disorientasi" }));
        ...
        SkalaResiko2.setBounds(240, 120, 430, 23);
        ...
        jLabel223.setText("3. Eliminasi");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(34, 150, 150, 23);

        jLabel224.setText("Skala :");
        jLabel224.setName("jLabel224"); // NOI18N
        FormInput.add(jLabel224);
        jLabel224.setBounds(176, 150, 60, 23);

        SkalaResiko3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Mandiri & Mampu Mengontrol BAB/BAK", "Dower Catheter/Colostomy", "Eliminasi Dengan Bantuan", "Gangguan Eliminasi (Inkontinensia/Nokturia/Frekuensi)", "Inkontinensia Tetapi Mampu Untuk Mobilisasi" }));
        ...
        SkalaResiko3.setBounds(240, 150, 430, 23);
        ...
        jLabel226.setText("4. Pengobatan");
        jLabel226.setName("jLabel226"); // NOI18N
        FormInput.add(jLabel226);
        jLabel226.setBounds(34, 180, 150, 23);

        jLabel227.setText("Skala :");
        jLabel227.setName("jLabel227"); // NOI18N
        FormInput.add(jLabel227);
        jLabel227.setBounds(176, 180, 60, 23);

        SkalaResiko4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Tanpa Obat-obatan", "Obat-obatan Jantung", "Obat-obatan Psikotropika (Termasuk Benzodiazepine & Antidepresan)", "Mendapat Tambahan Obat-obatan & Atau Obat PRN Selama 24 Jam Terakhir" }));
        ...
        SkalaResiko4.setBounds(240, 180, 430, 23);
        ...
        jLabel229.setText("6. Ambulasi/Keseimbangan");
        jLabel229.setName("jLabel229"); // NOI18N
        FormInput.add(jLabel229);
        jLabel229.setBounds(34, 240, 150, 23);

        jLabel230.setText("Skala :");
        jLabel230.setName("jLabel230"); // NOI18N
        FormInput.add(jLabel230);
        jLabel230.setBounds(176, 210, 60, 23);

        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Bipolar/Gangguan Schizoaffective", "Penggunaan Obat-obatan Terlarang, Ketergantungan Alkohol", "Gangguan Depresi Mayor", "Demensia/Delirium" }));
        ...
        SkalaResiko5.setBounds(240, 210, 430, 23);
        ...
        jLabel233.setBounds(176, 240, 60, 23);

        SkalaResiko6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Mandiri/Keseimbangan Baik/Imobilisasi", "Dengan Alat Bantu (Kursi Roda, Walker, Dll)", "Vertigo/Kelemahan", "Goyah/Membutuhkan Bantuan & Menyadari Kemampuan", "Goyah Tapi Lupa Keterbatasan" }));
        ...
        SkalaResiko6.setBounds(240, 240, 430, 23);
        ...
        jLabel30.setBounds(14, 300, 110, 23);
        ...
        jLabel31.setBounds(14, 370, 110, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_lanjutan_resiko_jatuh_psikiatri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",18,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptLanjutanRisikoJatuhPsikiatri.jasper","report","::[ Data Pengkajian Lanjutan Risiko Jatuh Psikiatri ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala1,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai1,"+
                    ...
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala3,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai3,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala4,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai4,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala5,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai5,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala6,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai6,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_totalnilai,penilaian_lanjutan_resiko_jatuh_psikiatri.hasil_skrining,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.saran,penilaian_lanjutan_resiko_jatuh_psikiatri.nip,petugas.nama "+
                    "from penilaian_lanjutan_resiko_jatuh_psikiatri inner join reg_periksa on penilaian_lanjutan_resiko_jatuh_psikiatri.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on penilaian_lanjutan_resiko_jatuh_psikiatri.nip=petugas.nip where "+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' "+
                    "order by penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal",param);
            }else{
                Valid.MyReportqry("rptLanjutanRisikoJatuhPsikiatri.jasper","report","::[ Data Pengkajian Lanjutan Risiko Jatuh Psikiatri ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala1,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on penilaian_lanjutan_resiko_jatuh_psikiatri.nip=petugas.nip where "+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' and "+
                    ...
                    "or penilaian_lanjutan_resiko_jatuh_psikiatri.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal ",param);
            }  
        }
    ...
    private void MnPenilaianLanjutanRisikoJatuhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianLanjutanRisikoJatuhActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirPenilaianLanjutanRisikoJatuhPsikiatri.jasper","report","::[ Formulir Pengkajian Lanjutan Risiko Jatuh Psikiatri ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala1,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai1,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala2,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai2,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala3,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai3,"+
                    ...
                    "from penilaian_lanjutan_resiko_jatuh_psikiatri inner join reg_periksa on penilaian_lanjutan_resiko_jatuh_psikiatri.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on penilaian_lanjutan_resiko_jatuh_psikiatri.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void SkalaResiko1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SkalaResiko1ItemStateChanged
        if(SkalaResiko1.getSelectedIndex()==0){
            ...
            NilaiResiko1.setText("8");
        }else if(SkalaResiko1.getSelectedIndex()==2){
            NilaiResiko1.setText("10");
        }else{
            NilaiResiko1.setText("26");
        }
        isTotalResikoJatuh();
    ...
    private void SkalaResiko2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SkalaResiko2ItemStateChanged
        if(SkalaResiko2.getSelectedIndex()==0){
            ...
            NilaiResiko2.setText("12");
        }else if(SkalaResiko2.getSelectedIndex()==3){
            NilaiResiko2.setText("13");
        }else{
    ...
    private void SkalaResiko5ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SkalaResiko5ItemStateChanged
        if(SkalaResiko5.getSelectedIndex()==0){
            ...
            NilaiResiko5.setText("8");
        }else if(SkalaResiko5.getSelectedIndex()==3){
            NilaiResiko5.setText("10");
        }else{
            NilaiResiko5.setText("12");
        }
        isTotalResikoJatuh();
    ...
    private void SkalaResiko6ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SkalaResiko6ItemStateChanged
        if(SkalaResiko6.getSelectedIndex()==0){
            ...
            NilaiResiko6.setText("8");
        }else if(SkalaResiko6.getSelectedIndex()==3){
            NilaiResiko6.setText("10");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanRisikoJatuhPsikiatri dialog = new RMPenilaianLanjutanRisikoJatuhPsikiatri(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on penilaian_lanjutan_resiko_jatuh_psikiatri.nip=petugas.nip where "+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal between ? and ? order by penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal,"+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala1,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on penilaian_lanjutan_resiko_jatuh_psikiatri.nip=petugas.nip where "+
                    "penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_lanjutan_resiko_jatuh_psikiatri.nip like ? or petugas.nama like ?) "+
                    "order by penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("penilaian_jatuhedmonson_totalnilai"),rs.getString("hasil_skrining"),rs.getString("saran"),rs.getString("nip"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_lanjutan_resiko_jatuh_psikiatri());
        BtnHapus.setEnabled(akses.getpenilaian_lanjutan_resiko_jatuh_psikiatri());
        BtnEdit.setEnabled(akses.getpenilaian_lanjutan_resiko_jatuh_psikiatri());
        BtnPrint.setEnabled(akses.getpenilaian_lanjutan_resiko_jatuh_psikiatri()); 
        if(akses.getjml2()>=1){
            NIP.setEditable(false);
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_psikiatri","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian_jatuhedmonson_skala1=?,penilaian_jatuhedmonson_nilai1=?,"+
                "penilaian_jatuhedmonson_skala2=?,penilaian_jatuhedmonson_nilai2=?,penilaian_jatuhedmonson_skala3=?,penilaian_jatuhedmonson_nilai3=?,penilaian_jatuhedmonson_skala4=?,"+
                "penilaian_jatuhedmonson_nilai4=?,penilaian_jatuhedmonson_skala5=?,penilaian_jatuhedmonson_nilai5=?,penilaian_jatuhedmonson_skala6=?,penilaian_jatuhedmonson_nilai6=?,"+
                "penilaian_jatuhedmonson_totalnilai=?,hasil_skrining=?,saran=?,nip=?",20,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                SkalaResiko1.getSelectedItem().toString(),NilaiResiko1.getText(),SkalaResiko2.getSelectedItem().toString(),NilaiResiko2.getText(),
                SkalaResiko3.getSelectedItem().toString(),NilaiResiko3.getText(),SkalaResiko4.getSelectedItem().toString(),NilaiResiko4.getText(), 
                SkalaResiko5.getSelectedItem().toString(),NilaiResiko5.getText(),SkalaResiko6.getSelectedItem().toString(),NilaiResiko6.getText(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_lanjutan_resiko_jatuh_psikiatri where tanggal=? and no_rawat=?",2,new String[]{
    ...
    private void isTotalResikoJatuh(){
        try {
            ...
            if(Integer.parseInt(NilaiResikoTotal.getText())<90){
                TingkatResiko.setText("Tingkat Resiko : Tidak Berisiko (0-89), Tindakan : Intervensi pencegahan risiko jatuh standar");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())>=90){
                TingkatResiko.setText("Tingkat Resiko : Risiko Tinggi (> 90), Tindakan : Intervensi pencegahan risiko jatuh standar dan Intervensi risiko jatuh tinggi");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
            TingkatResiko.setText("Tingkat Resiko : Tidak Berisiko (0-89), Tindakan : Intervensi pencegahan risiko jatuh standar");
