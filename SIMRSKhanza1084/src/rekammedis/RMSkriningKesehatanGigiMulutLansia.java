 ...
 * @author perpustakaan
 */
public final class RMSkriningKesehatanGigiMulutLansia extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMSkriningKesehatanGigiMulutLansia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Rutin Kontrol Gigi","Pola Makan Sehat","Sikat Gigi","Membersihkan Gigi Palsu","Gigi Berfungsi Baik",
            "Keluhan Mukosa Mulut","Hasil Skrining","Keterangan"
        }){
    ...
    private void initComponents() {
        ...
        PolaMakan = new widget.ComboBox();
        SikatGigi = new widget.ComboBox();
        jLabel81 = new widget.Label();
        jLabel82 = new widget.Label();
        jLabel83 = new widget.Label();
        jLabel84 = new widget.Label();
        GigiPalsu = new widget.ComboBox();
        ...
        GigiBerfungsi = new widget.ComboBox();
        jLabel87 = new widget.Label();
        jLabel88 = new widget.Label();
        MukosaMulut = new widget.ComboBox();

        jPopupMenu1.setName("jPopupMenu1"); // NOI18N

        MnSkriningKesehatanGigiMulutLansia.setBackground(new java.awt.Color(255, 255, 254));
        MnSkriningKesehatanGigiMulutLansia.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSkriningKesehatanGigiMulutLansia.setForeground(new java.awt.Color(50, 50, 50));
        MnSkriningKesehatanGigiMulutLansia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSkriningKesehatanGigiMulutLansia.setText("Formulir Skrining Kesehatan Gigi & Mulut Lansia");
        MnSkriningKesehatanGigiMulutLansia.setName("MnSkriningKesehatanGigiMulutLansia"); // NOI18N
        MnSkriningKesehatanGigiMulutLansia.setPreferredSize(new java.awt.Dimension(300, 26));
        MnSkriningKesehatanGigiMulutLansia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSkriningKesehatanGigiMulutLansiaActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnSkriningKesehatanGigiMulutLansia);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Skrining Kesehatan Gigi & Mulut Lansia ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel80.setText("Apakah Sudah Melakukan Pola Makan Yang Sehat Dan Pemilihan Makanan Yang Tepat ?");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(61, 120, 620, 23);

        PolaMakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        PolaMakan.setBounds(709, 120, 80, 23);

        SikatGigi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        SikatGigi.setName("SikatGigi"); // NOI18N
        SikatGigi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                SikatGigiKeyPressed(evt);
            }
        });
        FormInput.add(SikatGigi);
        SikatGigi.setBounds(709, 150, 80, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Berapa Kali Sikat Gigi Dalam Sehari (Minimal 2 Kali) ?");
        ...
        jLabel83.setText("Jika Menggunakan Gigi Palsu, Apakah Rutin Selalu Dibersihkan ?");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(61, 180, 550, 23);
        ...
        GigiPalsu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        GigiPalsu.setName("GigiPalsu"); // NOI18N
        GigiPalsu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                GigiPalsuKeyPressed(evt);
            }
        });
        FormInput.add(GigiPalsu);
        GigiPalsu.setBounds(709, 180, 80, 23);
        ...
        HasilSkrining.setBounds(121, 290, 195, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("Hasil Skrining");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(44, 290, 100, 23);

        jLabel93.setText("Keterangan :");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(320, 290, 75, 23);
        ...
        Keterangan.setBounds(399, 290, 390, 23);

        jLabel27.setText(":");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 290, 117, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel85.setText("Apakah Masih Memiliki Gigi Yang Berfungsi Baik (Minimal 20 Gigi Tidak Goyang & Lubang) ?");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(61, 210, 550, 23);
        ...
        GigiBerfungsi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        GigiBerfungsi.setName("GigiBerfungsi"); // NOI18N
        GigiBerfungsi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                GigiBerfungsiKeyPressed(evt);
            }
        });
        FormInput.add(GigiBerfungsi);
        GigiBerfungsi.setBounds(709, 210, 80, 23);

        jLabel87.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel87.setText("Apakah Ada Keluhan Pada Mukosa Mulut (Deteksi Dini Penyakit Mulut) ?");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(61, 240, 550, 23);

        jLabel88.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel88.setText("6.");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(44, 240, 20, 23);

        MukosaMulut.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        MukosaMulut.setName("MukosaMulut"); // NOI18N
        MukosaMulut.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                MukosaMulutKeyPressed(evt);
            }
        });
        FormInput.add(MukosaMulut);
        MukosaMulut.setBounds(709, 240, 80, 23);
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append("<tr class='isi'>").
                                            ...
                                            append("<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Rutin Kontrol Gigi</b></td>").
                                            append("<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Pola Makan Sehat</b></td>").
                                            append("<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Sikat Gigi</b></td>").
                                            append("<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Membersihkan Gigi Palsu</b></td>").
                                            append("<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Gigi Berfungsi Baik</b></td>").
                                            append("<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Keluhan Mukosa Mulut</b></td>").
    ...
    private void btnPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPetugasKeyPressed
        Valid.pindah(evt,Detik,RutinKontrol);
    }//GEN-LAST:event_btnPetugasKeyPressed

    private void MnSkriningKesehatanGigiMulutLansiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSkriningKesehatanGigiMulutLansiaActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirSkriningKesehatanGigiMulutLansia.jasper","report","::[ Formulir Skrining Kesehatan Gigi & Mulut Lansia ]::",
                    ...
                    "skrining_kesehatan_gigi_mulut_lansia.gigi_berfungsi,skrining_kesehatan_gigi_mulut_lansia.mukosa_mulut,skrining_kesehatan_gigi_mulut_lansia.hasil_skrining,skrining_kesehatan_gigi_mulut_lansia.keterangan "+
                    "from skrining_kesehatan_gigi_mulut_lansia inner join reg_periksa on skrining_kesehatan_gigi_mulut_lansia.no_rawat=reg_periksa.no_rawat inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on skrining_kesehatan_gigi_mulut_lansia.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    }//GEN-LAST:event_MnSkriningKesehatanGigiMulutLansiaActionPerformed

    private void RutinKontrolKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RutinKontrolKeyPressed
        Valid.pindah(evt,btnPetugas,PolaMakan);
    ...
    private void PolaMakanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PolaMakanKeyPressed
        Valid.pindah(evt,RutinKontrol,SikatGigi);
    }//GEN-LAST:event_PolaMakanKeyPressed

    private void SikatGigiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SikatGigiKeyPressed
        Valid.pindah(evt,PolaMakan,GigiPalsu);
    }//GEN-LAST:event_SikatGigiKeyPressed

    private void GigiPalsuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_GigiPalsuKeyPressed
        Valid.pindah(evt,SikatGigi,HasilSkrining);
    }//GEN-LAST:event_GigiPalsuKeyPressed
    ...
    private void HasilSkriningKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HasilSkriningKeyPressed
        Valid.pindah(evt,GigiPalsu,Keterangan);
    ...
    private void GigiBerfungsiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_GigiBerfungsiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_GigiBerfungsiKeyPressed

    private void MukosaMulutKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MukosaMulutKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_MukosaMulutKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSkriningKesehatanGigiMulutLansia dialog = new RMSkriningKesehatanGigiMulutLansia(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox GigiBerfungsi;
    private widget.ComboBox GigiPalsu;
    ...
    private javax.swing.JMenuItem MnSkriningKesehatanGigiMulutLansia;
    private widget.ComboBox MukosaMulut;
    private widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private widget.ComboBox PolaMakan;
    private widget.ComboBox RutinKontrol;
    private widget.ScrollPane Scroll;
    private widget.ComboBox SikatGigi;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "skrining_kesehatan_gigi_mulut_lansia.gigi_berfungsi,skrining_kesehatan_gigi_mulut_lansia.mukosa_mulut,skrining_kesehatan_gigi_mulut_lansia.hasil_skrining,skrining_kesehatan_gigi_mulut_lansia.keterangan "+
                    "from skrining_kesehatan_gigi_mulut_lansia inner join reg_periksa on skrining_kesehatan_gigi_mulut_lansia.no_rawat=reg_periksa.no_rawat inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on skrining_kesehatan_gigi_mulut_lansia.nip=petugas.nip where skrining_kesehatan_gigi_mulut_lansia.tanggal between ? and ? order by skrining_kesehatan_gigi_mulut_lansia.tanggal ");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,skrining_kesehatan_gigi_mulut_lansia.nip,petugas.nama,skrining_kesehatan_gigi_mulut_lansia.tanggal,"+
                    "skrining_kesehatan_gigi_mulut_lansia.kontrol_gigi,skrining_kesehatan_gigi_mulut_lansia.pola_makan,skrining_kesehatan_gigi_mulut_lansia.sikat_gigi,skrining_kesehatan_gigi_mulut_lansia.gigi_palsu,"+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("kontrol_gigi"),rs.getString("pola_makan"),rs.getString("sikat_gigi"),rs.getString("gigi_palsu"),rs.getString("gigi_berfungsi"),rs.getString("mukosa_mulut"),rs.getString("hasil_skrining"),
    ...
    public void emptTeks() {
        ...
        SikatGigi.setSelectedIndex(0);
        GigiPalsu.setSelectedIndex(0);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            PolaMakan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            SikatGigi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            GigiPalsu.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            GigiBerfungsi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("skrining_kesehatan_gigi_mulut_lansia","no_rawat=?","no_rawat=?,tanggal=?,kontrol_gigi=?,pola_makan=?,sikat_gigi=?,gigi_palsu=?,gigi_berfungsi=?,mukosa_mulut=?,hasil_skrining=?,keterangan=?,nip=?",12,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),RutinKontrol.getSelectedItem().toString(),PolaMakan.getSelectedItem().toString(),
                SikatGigi.getSelectedItem().toString(),GigiPalsu.getSelectedItem().toString(),GigiBerfungsi.getSelectedItem().toString(),MukosaMulut.getSelectedItem().toString(),HasilSkrining.getText(),Keterangan.getText(),KdPetugas.getText(),
               ...
               tbObat.setValueAt(PolaMakan.getSelectedItem().toString(),tbObat.getSelectedRow(),9);
               tbObat.setValueAt(SikatGigi.getSelectedItem().toString(),tbObat.getSelectedRow(),10);
               tbObat.setValueAt(GigiPalsu.getSelectedItem().toString(),tbObat.getSelectedRow(),11);
               tbObat.setValueAt(GigiBerfungsi.getSelectedItem().toString(),tbObat.getSelectedRow(),12);
               tbObat.setValueAt(MukosaMulut.getSelectedItem().toString(),tbObat.getSelectedRow(),13);
               tbObat.setValueAt(HasilSkrining.getText(),tbObat.getSelectedRow(),14);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from skrining_kesehatan_gigi_mulut_lansia where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){
    ...
    private void simpan() {
        if(Sequel.menyimpantf("skrining_kesehatan_gigi_mulut_lansia","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
            ...
            tabMode.addRow(new Object[]{
                ...
                RutinKontrol.getSelectedItem().toString(),PolaMakan.getSelectedItem().toString(),SikatGigi.getSelectedItem().toString(),GigiPalsu.getSelectedItem().toString(),GigiBerfungsi.getSelectedItem().toString(),MukosaMulut.getSelectedItem().toString(),
