 ...
 * @author perpustakaan
 */
public final class PengumumanEPasien extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PengumumanEPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.","NIP","Diposting Oleh","Tanggal","Pengumuman"
            }){
    ...
    private void initComponents() {
        ...
        Pengumuman = new widget.TextArea();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengumuman E-Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(72, 112));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-05-2020 16:25:13" }));
        ...
        Pengumuman.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Pengumuman.setColumns(20);
        Pengumuman.setRows(5);
        Pengumuman.setName("Pengumuman"); // NOI18N
        scrollPane1.setViewportView(Pengumuman);

        FormInput.add(scrollPane1);
        scrollPane1.setBounds(106, 40, 619, 40);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Pengumuman.getText().trim().equals("")){
            Valid.textKosong(Pengumuman,"Pengumuman");
        }else if(NmPetugas.getText().trim().equals("")){
            Valid.textKosong(KdPetugas,"Pemosting Pengumuman");
        }else{
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Pengumuman,BtnBatal);
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Pengumuman.getText().trim().equals("")){
            Valid.textKosong(Pengumuman,"Kegiatan");
        }else if(NmPetugas.getText().trim().equals("")){
            Valid.textKosong(KdPetugas,"Pemosting Pengumuman");
        }else{
            if(tbObat.getSelectedRow()> -1){
                if(Sequel.mengedittf("pengumuman_epasien","nik=? and tanggal=?","nik=?,tanggal=?,pengumuman=?",5,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptPengumumanEPasien.jasper","report","::[ Pengumuman Untuk E-Pasien ]::",
                   ...
                   "pengumuman_epasien.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' "+
                   "and (pengumuman_epasien.nik like '%"+TCari.getText().trim()+"%' or pegawai.nama like '%"+TCari.getText().trim()+"%' or pengumuman_epasien.pengumuman like '%"+TCari.getText().trim()+"%') "+
                   "order by pengumuman_epasien.tanggal desc",param);
        }
...
private void KdPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdPetugasKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select nama from petugas where nik=?",NmPetugas,KdPetugas.getText());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PengumumanEPasien dialog = new PengumumanEPasien(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea Pengumuman;
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   "select pengumuman_epasien.nik,pegawai.nama,pengumuman_epasien.tanggal,pengumuman_epasien.pengumuman "+
                   "from pengumuman_epasien inner join pegawai on pengumuman_epasien.nik=pegawai.nik where "+
                   "pengumuman_epasien.tanggal between ? and ? and (pengumuman_epasien.nik like ? or pegawai.nama like ? or pengumuman_epasien.pengumuman like ?) "+
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Pengumuman.setText(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString());
        }
    }
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput.setPreferredSize(new Dimension(WIDTH,112));
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpengumuman_epasien());
        BtnHapus.setEnabled(akses.getpengumuman_epasien());
        BtnEdit.setEnabled(akses.getpengumuman_epasien());
        if(akses.getjml2()>=1){
            KdPetugas.setEditable(false);
