 ...
 * @author salimmulyana
 */
public final class SuratKewaspadaanKesehatan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratKewaspadaanKesehatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Keluhan.setDocument(new batasInput((byte)50).getKata(Keluhan));           
    ...
    private void initComponents() {
        ...
        MnCetakSuratKewaspadaanKesehatan.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakSuratKewaspadaanKesehatan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratKewaspadaanKesehatan.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratKewaspadaanKesehatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratKewaspadaanKesehatan.setText("Cetak Surat Keterangan Kewaspadaan Kesehatan");
        MnCetakSuratKewaspadaanKesehatan.setName("MnCetakSuratKewaspadaanKesehatan"); // NOI18N
        MnCetakSuratKewaspadaanKesehatan.setPreferredSize(new java.awt.Dimension(316, 18));
        MnCetakSuratKewaspadaanKesehatan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratKewaspadaanKesehatanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratKewaspadaanKesehatan);

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setUndecorated(true);
        setResizable(false);

        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Kewaspadaan Kesehatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-09-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-09-2021" }));
        ...
        TPasien.setBounds(321, 10, 245, 23);
        ...
        jLabel13.setBounds(573, 10, 55, 23);

        jLabel14.setText("Keluhan :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(218, 40, 60, 23);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-09-2021" }));
        TanggalPeriksa.setDisplayFormat("dd-MM-yyyy");
        TanggalPeriksa.setName("TanggalPeriksa"); // NOI18N
        FormInput.add(TanggalPeriksa);
        TanggalPeriksa.setBounds(632, 10, 90, 23);

        jLabel5.setText("Keperluan :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(460, 40, 68, 23);
        ...
        Keperluan.setBounds(534, 40, 188, 23);
        ...
        Keluhan.setBounds(282, 40, 170, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            Valid.textKosong(TNoRw,"Keluhan");
        }else{
            if(Sequel.menyimpantf("surat_kewaspadaan_kesehatan","?,?,?,?,?","No.Surat",5,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),Keluhan.getText(),Keperluan.getText()
            })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Keperluan,BtnBatal);
        }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper","report","::[ Data Surat Keterangan Kewaspadaan Kesehatan ]::",
                     ...
                     "where "+tgl+"order by surat_kewaspadaan_kesehatan.no_surat",param);
            }else{
                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper","report","::[ Data Surat Keterangan Kewaspadaan Kesehatan ]::",
                     "select surat_kewaspadaan_kesehatan.no_surat,surat_kewaspadaan_kesehatan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_kewaspadaan_kesehatan.tanggalperiksa,surat_kewaspadaan_kesehatan.keluhan_saat_ini,reg_periksa.kd_dokter,dokter.nm_dokter,surat_kewaspadaan_kesehatan.keperluan "+                  
                     "from surat_kewaspadaan_kesehatan inner join reg_periksa on surat_kewaspadaan_kesehatan.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on dokter.kd_dokter=reg_periksa.kd_dokter "+
                     "where "+tgl+"and (no_surat like '%"+TCari.getText().trim()+"%' or surat_kewaspadaan_kesehatan.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     "reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or  pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     "surat_kewaspadaan_kesehatan.tanggalperiksa like '%"+TCari.getText().trim()+"%' or surat_kewaspadaan_kesehatan.keperluan like '%"+TCari.getText().trim()+"%') "+                    
                     "order by surat_kewaspadaan_kesehatan.no_surat",param);
            }
    ...
    private void MnCetakSuratKewaspadaanKesehatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKewaspadaanKesehatanActionPerformed
    ...
    }//GEN-LAST:event_MnCetakSuratKewaspadaanKesehatanActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKewaspadaanKesehatan dialog = new SuratKewaspadaanKesehatan(new javax.swing.JFrame(), true);
            ...
            if(TCari.getText().trim().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    "select surat_kewaspadaan_kesehatan.no_surat,surat_kewaspadaan_kesehatan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     ...
                     "reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or  pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     "surat_kewaspadaan_kesehatan.tanggalperiksa like '%"+TCari.getText().trim()+"%' or surat_kewaspadaan_kesehatan.keperluan like '%"+TCari.getText().trim()+"%') "+                    
                     "order by surat_kewaspadaan_kesehatan.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_kewaspadaan_kesehatan.no_surat,3),signed)),0) from surat_kewaspadaan_kesehatan where surat_kewaspadaan_kesehatan.tanggalperiksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"' ",
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Keluhan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());  
