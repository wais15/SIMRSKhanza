<?php
    ...
    $_sql          = "select * from antrilayanankedokteranfisikrehabilitasi" ;  
...
<body>
    <div class="container">
        ...
        <form method="POST" action="pages/storeImage.php" onsubmit="return validasiIsi();" enctype=multipart/form-data>
            ...
            <br/>
            <h7 class="text-dark">
                Bahwa saya telah mendapatkan pelayanan rehabilitasi medik di <?=$namars?> dengan : 
            </h7>
            <table class="default" width="98%" border="0" align="center" cellpadding="3px" cellspacing="0px">
                <tr class="text-dark">
                    <td width="25%">Anamnesa</td>
                    <td width="75%">: <?=$anamnesa;?></td>
                </tr>
                <tr class="text-dark">
                    <td width="25%">Pemeriksaan Fisik</td>
                    <td width="70%">: <?=$pemeriksaan_fisik;?></td>
                </tr>
                <tr class="text-dark">
