<?php
    ...
    function cekSessiAdmin() {
        if (isset($_SESSION['ses_admin_kepegawaian'])) {
            return true;
        } else {
            return false;
        }
    ...
    function actionPages() {
        $aksi=isset($_REQUEST['act'])?$_REQUEST['act']:NULL;
            ...
            switch ($aksi) {
                ...
                case 'DetailEvaluasiKinerja'            : include_once('pages/pegawai/detailevaluasikinerja.php'); break;
                case 'DetailPencapaianKinerja'          : include_once('pages/pegawai/detailpencapaiankinerja.php'); break;
                ...
                case 'ListKelompokJabatan'              : include_once('pages/kelompokjabatan/listkelompokjabatan.php'); break;
                case 'InputKelompokJabatan'             : include_once('pages/kelompokjabatan/inputkelompokjabatan.php'); break;
                case 'ListResikoKerja'                  : include_once('pages/resikokerja/listresikokerja.php'); break;
                case 'InputResikoKerja'                 : include_once('pages/resikokerja/inputresikokerja.php'); break;
                case 'ListEmergencyIndex'               : include_once('pages/emergencyindex/listemergencyindex.php'); break;
                case 'InputEmergencyIndex'              : include_once('pages/emergencyindex/inputemergencyindex.php'); break;
                case 'ListPencapaianKinerja'            : include_once('pages/pencapaiankinerja/listpencapaiankinerja.php'); break;
