    ...
    if(mysqli_num_rows($hasil)!=0) {
        echo "<table width='99.8%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                ...
                while($baris = mysqli_fetch_array($hasil)) {
                    ...
                    $_sql2 = "SELECT riwayat_pendidikan.pendidikan,riwayat_pendidikan.sekolah,riwayat_pendidikan.thn_lulus from riwayat_pendidikan where riwayat_pendidikan.id='$baris[0]' ORDER BY riwayat_pendidikan.thn_lulus ASC ";
